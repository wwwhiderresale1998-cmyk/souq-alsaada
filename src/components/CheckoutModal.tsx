                    ...
                    <div className="relative">
                      ...
                      {onZoomImage && (
                        <button
                          ...
                          className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover/coImg:opacity-100 transition-opacity rounded-lg cursor-pointer"
                          title="تكبير الصورة"
                        >
                ...
                <div className="relative">
                  ...
                  {onZoomImage && (
                    <button
                      ...
                      className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover/coImgSingle:opacity-100 transition-opacity rounded-xl cursor-pointer"
                      title="تكبير الصورة"
                    >
